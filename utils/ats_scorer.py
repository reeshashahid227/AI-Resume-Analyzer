...
def contains_word(term, text):
    """Match a skill/keyword as a whole word, not as a substring.
    Prevents false positives like 'git' matching inside 'digital'."""
